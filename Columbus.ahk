...
#Include %A_ScriptDir%\lib\Class Commands.ahk
#Include %A_ScriptDir%\lib\Class CtlColors.ahk
#Include %A_ScriptDir%\lib\Class Gui.ahk
#Include %A_ScriptDir%\lib\Class Hotkey.ahk
#Include %A_ScriptDir%\lib\Class Items.ahk
#Include %A_ScriptDir%\lib\Class List.ahk
#Include %A_ScriptDir%\lib\Class MainGui.ahk
#Include %A_ScriptDir%\lib\Class Plugin.ahk
#Include %A_ScriptDir%\lib\Class Settings.ahk
#Include %A_ScriptDir%\lib\Class Menu.ahk
#Include %A_ScriptDir%\lib\Class Notify.ahk
#Include %A_ScriptDir%\lib\Class xmlfile.ahk
#Include %A_ScriptDir%\lib\EditAction.ahk
#Include %A_ScriptDir%\lib\Functions.ahk
#Include %A_ScriptDir%\lib\Fuzzy.ahk
#Include %A_ScriptDir%\lib\Hotkeys.ahk
#Include %A_ScriptDir%\lib\ListAction.ahk
#Include %A_ScriptDir%\lib\Manager.ahk
#Include %A_ScriptDir%\lib\Menus.ahk
#Include %A_ScriptDir%\lib\Settings.ahk
#Include %A_ScriptDir%\lib\String.ahk
#Include %A_ScriptDir%\lib\Submit.ahk
